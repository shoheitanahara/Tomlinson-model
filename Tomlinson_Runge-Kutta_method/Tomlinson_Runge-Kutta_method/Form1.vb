Public Class Form1
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        For i = 0 To n
            ...
            kxs1 = dt * Gy(t, xt, vt, xs, vs)
            lxs1 = dt * Fy(t, xt, vt, xs, vs)
            kxt1 = dt * Gx(t, xt, vt, xs, vs)
            lxt1 = dt * Fx(t, xt, vt, xs, vs)

            kxs2 = dt * Gy(t + dt / 2, xt + kxt1 / 2, vt + lxt1 / 2, xs + kxs1 / 2, vs + lxs1 / 2)
            lxs2 = dt * Fy(t + dt / 2, xt + kxt1 / 2, vt + lxt1 / 2, xs + kxs1 / 2, vs + lxs1 / 2)
            kxt2 = dt * Gx(t + dt / 2, xt + kxt1 / 2, vt + lxt1 / 2, xs + kxs1 / 2, vs + lxs1 / 2)
            lxt2 = dt * Fx(t + dt / 2, xt + kxt1 / 2, vt + lxt1 / 2, xs + kxs1 / 2, vs + lxs1 / 2)

            kxs3 = dt * Gy(t + dt / 2, xt + kxt2 / 2, vt + lxt2 / 2, xs + kxs2 / 2, vs + lxs2 / 2)
            lxs3 = dt * Fy(t + dt / 2, xt + kxt2 / 2, vt + lxt2 / 2, xs + kxs2 / 2, vs + lxs2 / 2)
            kxt3 = dt * Gx(t + dt / 2, xt + kxt2 / 2, vt + lxt2 / 2, xs + kxs2 / 2, vs + lxs2 / 2)
            lxt3 = dt * Fx(t + dt / 2, xt + kxt2 / 2, vt + lxt2 / 2, xs + kxs2 / 2, vs + lxs2 / 2)

            kxs4 = dt * Gy(t + dt, xt + kxt3, vt + lxt3, xs + kxs3, vs + lxs3)
            lxs4 = dt * Fy(t + dt, xt + kxt3, vt + lxt3, xs + kxs3, vs + lxs3)
            kxt4 = dt * Gx(t + dt, xt + kxt3, vt + lxt3, xs + kxs3, vs + lxs3)
            lxt4 = dt * Fx(t + dt, xt + kxt3, vt + lxt3, xs + kxs3, vs + lxs3)
            ...
            'フーリエ係数を求める　<fsub*cos(t)/xso>および<fsub*sin(t)/xso>
            If t > 2 * Pi AndAlso t < 4 * Pi Then
                fourier_C = fourier_C + (1 / (2 * Pi)) * fsub / xso * Math.Cos(t) * dt
                fourier_S = fourier_S + (1 / (2 * Pi)) * fsub / xso * Math.Sin(t) * dt
            End If
    ...
    Function Fx(ByVal t, ByVal xt, ByVal vt, ByVal xs, ByVal vs)
    ...
    Function Gx(ByVal t, ByVal xt, ByVal vt, ByVal xs, ByVal vs)

        'vt = xt / dt
        vt = -Kk * xt - Hn * (vt - vs) - u * Math.Sin(xt - xs)
        fsub = Hn * (vt - vs) + u * Math.Sin(xt - xs)
        Gx = vt

    End Function

    Function Fy(ByVal t, ByVal xt, ByVal vt, ByVal xs, ByVal vs)
    ...
    Function Gy(ByVal t, ByVal xt, ByVal vt, ByVal xs, ByVal vs)
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        For j = 0 To 300
            ...
            For i = 0 To n
                ...
                'ルンゲ=クッタ法
                Dim kxt1 As Double = 0
                Dim lxt1 As Double = 0
                Dim kxs1 As Double = 0
                Dim lxs1 As Double = 0
                Dim kxt2 As Double = 0
                Dim lxt2 As Double = 0
                Dim kxs2 As Double = 0
                Dim lxs2 As Double = 0
                Dim kxt3 As Double = 0
                Dim lxt3 As Double = 0
                Dim kxs3 As Double = 0
                Dim lxs3 As Double = 0
                Dim kxt4 As Double = 0
                Dim lxt4 As Double = 0
                Dim kxs4 As Double = 0
                Dim lxs4 As Double = 0
